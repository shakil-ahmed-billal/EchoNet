...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('LIKE', 'REACTION', 'COMMENT', 'REPLY', 'MESSAGE', 'ANNOUNCEMENT', 'CALL', 'FOLLOW', 'FOLLOW_REQUEST', 'MENTION', 'STORY_VIEW', 'SHARE', 'FRIEND_REQUEST', 'FRIEND_ACCEPT');
