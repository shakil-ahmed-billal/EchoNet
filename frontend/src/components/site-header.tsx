    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-xl h-14 md:h-16 flex items-center shadow-sm">
      <div className="w-full mx-auto px-4 md:px-6 lg:px-8 flex items-center justify-between gap-4">
        <div className="flex items-center gap-6 sm:gap-10">
          ...
          <div
            ref={searchRef}
            className="hidden md:flex items-center relative group min-w-[200px] lg:min-w-[320px]"
          >
                ...
                {isSearching ? (
                  ...
                  searchResults.map((u: UserSuggestion) => (
                    ...
                    >
                      <UserImage
                        user={u}
                        className="h-9 w-9 ring-1 ring-border/10"
                      />
            ...
            {isAuthenticated ? (
                  ...
                  <div className="hidden sm:flex items-center gap-1">
                    <Link href="/feed?create=true">
                      <Button
                        variant="ghost"
                        size="icon"
                        className="size-10 rounded-full text-muted-foreground hover:bg-muted/80 hover:text-foreground"
                      >
              ...
              <div className="flex gap-2">
                ...
                <Link href="/register">
                  <Button
                    size="sm"
                    className="text-xs font-bold rounded-xl px-6 h-9 shadow-sm hover:shadow-sm active:scale-95 transition-all"
                  >
                    Get Started
                  </Button>
                </Link>
